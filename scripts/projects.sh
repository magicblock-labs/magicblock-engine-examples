...
REGULAR_PROJECTS=(anchor-counter binary-prediction crank-counter ephemeral-account-chats magic-actions pinocchio-counter rust-counter session-keys spl-tokens)
