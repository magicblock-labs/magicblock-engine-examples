...
REGULAR_PROJECTS=(anchor-counter binary-prediction crank-counter dummy-token-transfer eata-pda-undelegate ephemeral-account-chats magic-actions oracle-priced-purchase pinocchio-counter rust-counter session-keys spl-tokens)
