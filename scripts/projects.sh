...
REGULAR_PROJECTS=(anchor-counter crank-counter dummy-token-transfer ephemeral-account-chats magic-actions oracle-trading pinocchio-counter rust-counter session-keys spl-tokens)
