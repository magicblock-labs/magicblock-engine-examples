...
describe.skip("on-curve-delegation-kit", async () => {
  ...
  it(
    ...
    async () => {
      ...
      const delegationProgramAddress = address(
  ...
  it(
    ...
    async () => {
      ...
      const commitInstruction = createCommitInstruction(userAddress, [
        userAddress,
      ]);
      ...
      const transactionMessage = pipe(
        ...
        (tx) => appendTransactionMessageInstructions([commitInstruction], tx),
      );
  ...
  it(
    ...
    async () => {
      ...
      const commitAndUndelegateInstruction =
        createCommitAndUndelegateInstruction(userAddress, [userAddress]);
