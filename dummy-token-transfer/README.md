...
`yarn setup` runs `SETUP_ONLY=1 ./scripts/test-locally.sh dummy-token-transfer` from the repo root: it builds this example, boots the validators, and holds them until you press a key.
