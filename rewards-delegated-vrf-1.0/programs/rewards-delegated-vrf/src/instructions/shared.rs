    ...
    match reward_type {
        RewardType::SplToken | RewardType::LegacyNft => {
            ...
            let action_accounts = vec![
                ShortAccountMeta {
                    pubkey: token_program.to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
                    pubkey: source_token_address.key().to_bytes().into(),
                    is_writable: true,
                },
                ShortAccountMeta {
                    pubkey: mint.to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
                    pubkey: destination_token_address.to_bytes().into(),
                    is_writable: true,
                },
                ShortAccountMeta {
                    pubkey: reward_distributor.key().to_bytes().into(),
                    is_writable: true,
                },
                ShortAccountMeta {
                    pubkey: destination.key().to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
                    pubkey: ata_program.to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
        ...
        RewardType::ProgrammableNft => {
            ...
            let action_accounts = vec![
                ...
                ShortAccountMeta {
                    pubkey: token_metadata_program.to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
                    pubkey: sysvar_instructions_program.to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
                    pubkey: auth_rule_program.to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
                    pubkey: metadata_pda.to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
                    pubkey: edition_pda.to_bytes().into(),
                    is_writable: false,
                },
                ShortAccountMeta {
                    pubkey: source_token_record_pda.to_bytes().into(),
                    is_writable: true,
                },
                ShortAccountMeta {
                    pubkey: destination_token_record_pda.to_bytes().into(),
                    is_writable: true,
                },
                ShortAccountMeta {
                    pubkey: auth_rule_pda.to_bytes().into(),
                    is_writable: false,
                },
            ];
