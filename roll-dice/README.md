...
`yarn setup` runs `SETUP_ONLY=1 ./test-locally.sh roll-dice` from the repo root: it builds this example, boots the validators and VRF oracle, and holds them until you press a key.
