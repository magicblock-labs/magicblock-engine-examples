...
`yarn setup` runs `SETUP_ONLY=1 ./test-locally.sh spl-tokens` from the repo root: it builds this example, boots the validators, and holds them until you press a key.
