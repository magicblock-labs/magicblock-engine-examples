    ...
    configure: (webpackConfig) => {
      ...
      webpackConfig.plugins = (webpackConfig.plugins || []).concat(
        ...
        new webpack.DefinePlugin({
          "process.env.SETUP_MINT": JSON.stringify(
            process.env.SETUP_MINT || "",
          ),
          "process.env.SETUP_QUEUE_KEYPAIR": JSON.stringify(
            setupQueueKeypairPath,
          ),
          "process.env.SETUP_QUEUE_KEYPAIR_JSON": JSON.stringify(
            setupQueueKeypairJson,
          ),
        }),
      );
